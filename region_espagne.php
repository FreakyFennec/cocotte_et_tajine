...
<html>
	...
	<body>
		...
		<h3 class="elem_nom_result_recherche">Toutes les recettes d'Espagne.</h3>
		...
		<?php
			...
			// Partie "Requête"
			$debut = ($page - 1) * $limite;
			$query = 'SELECT SQL_CALC_FOUND_ROWS R.id_recette, R.recette, R.nom_img, R.alt_img, R.presentation,  
								R.regOrigId, O.origine_id, C.id_recet_com,
			...
			while ($element = $query->fetch()) {
			   ...
			   echo nl2br('<div class="zone_recet_pays"><div class="zone_nom_origine_pays"><h3 class="elem_nom_recet_pays">'.htmlspecialchars($element['recette']).'</h3><p class="origine_pays">('.htmlspecialchars($element['origine_id']).')</p><p class="nbre_com_pays">Nbre de com. : '.htmlspecialchars($element['total_com']).'</p></div>
